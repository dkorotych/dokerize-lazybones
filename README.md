...
```docker
docker run --rm --interactive --tty --volume $PWD:/home/lazybones/app dkorotych/lazybones:0.8.2-jre8 create https://dl.bintray.com/dkorotych/lazybones-templates/maven-quickstart-template-1.3.2.zip .
```
# Create an alias
